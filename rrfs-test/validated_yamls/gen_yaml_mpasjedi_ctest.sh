...
add_to_dict obtype_configs keys_obtype "aircar_specificHumidity_133_MPAS.yaml" "data/obs/ioda_aircar_dc.nc"
...
add_to_dict obtype_configs keys_obtype "aircft_specificHumidity_134_MPAS.yaml" "data/obs/ioda_aircft_dc.nc"
...
add_to_dict obtype_configs keys_obtype "msonet_specificHumidity_188_MPAS.yaml" "data/obs/ioda_msonet_dc.nc"
...
add_to_dict obtype_configs keys_obtype "adpsfc_specificHumidity_187_MPAS.yaml" "data/obs/ioda_adpsfc_dc.nc"
...
#add_to_dict obtype_configs keys_obtype "vadwnd_winds_224.yaml"                 "data/obs/ioda_vadwnd_dc.nc" # waiting for phase 3 
#add_to_dict obtype_configs keys_obtype "rassda_airTemperature_126.yaml"        "data/obs/ioda_rassda_dc.nc" # waiting for phase 3 
add_to_dict obtype_configs keys_obtype "atms_npp_qc_bc.yaml"                   "data/obs/atms_npp_obs_2024052700_dc.nc"
add_to_dict obtype_configs keys_obtype "atms_n20.yaml"                         "data/obs/atms_n20_obs_2024052700_dc.nc"
